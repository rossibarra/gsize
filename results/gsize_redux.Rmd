...
#percent mapping, change columns, fix filenames
hm2_perc<-read.csv("~/Downloads/fixed_genes_percent.txt",header=F)
colnames(hm2_perc)=c("Line","total_reads","total_genes","mapped_reads","mapped_genes","percent")
#hm2_perc$Line=gsub("_merged.fq.bam.txt","",gsub("abundance.","",hm2_perc$Line))
hm2_perc$Line=gsub(".bam.txt","",gsub("abundance.","",hm2_perc$Line))
hm2_perc$Line=gsub("IL14H","Il14H",hm2_perc$Line)
